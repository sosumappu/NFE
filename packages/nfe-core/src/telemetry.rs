...
pub enum TelemetryTopic {
    ...
    MappingGlobalMapScene,
    MappingStatus,
    MappingLoopClosure,
    RaceStartLine,
    RaceLap,
    PlanningRaceLine,
    PlanningRaceLineScene,
...
impl TelemetryTopic {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            TelemetryTopic::MappingGlobalMapScene => "/mapping/global_map_scene",
            ...
            TelemetryTopic::PlanningRaceLineScene => "/planning/raceline_scene",
